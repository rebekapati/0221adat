...
CREATE TABLE [dbo].[Ugyfel](
	...
	[SZULEV] [int] MASKED WITH (FUNCTION = 'random(1990,2000)') NULL,
...
select N'ZSUZSAV',N'zsuzsa.vajda@mail.hu',N'Vajda Zsuzsa',1976,N'N',N'6786 Ruzsa, Kossuth utca 77.';Ugyfel

--user, maszkolás, eredeti lekérdezése
